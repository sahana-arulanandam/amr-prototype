...
: ${AMENT_CURRENT_PREFIX:="/home/amr/icarus_ws/install/nav2_client"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_client/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_client/environment/path.sh"
